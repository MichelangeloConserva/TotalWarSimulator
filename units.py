...
dumping_intra            = 2
FORCE_MULTIPLIER         = 10
stifness_intra           = FORCE_MULTIPLIER * 10
LATERAL_NOISE_MULTIPLIER = FORCE_MULTIPLIER * 10
...
class Melee_Unit:
    ...
    def calc_width(self, upr): return upr*self.soldier.radius*2 + (upr-1) * self.soldier.dist        
    ...
    def add_defensive_springs(self):
        ...
        for s in self.soldiers:
            ...
            spring = pymunk.DampedSpring(s.body, b0, Vec2d(), s.body.position, 
                                          rest_length = 0, 
                                          stiffness = s.body.mass * FORCE_MULTIPLIER, 
                                          damping = 0.8)        
    ...
    def update(self, dt):
        ...
        if not self.order is None:
            ...
            if max(ds) < Melee_Soldier.radius:
