...
class Person:
  ...
  @property
  def nns(self): return [self.front_nn,self.right_nn, self.bot_nn, self.left_nn]
  @property
  def is_at_border(self):
    for nn in self.nns:
      if nn is None: return True
    return False
  ...
  def move(self, speed, is_fighting, FORCE_MULTIPLIER, ATTACKING_MULTIPLIERS, LATERAL_NOISE_MULTIPLIER):
...
# =============================================================================
  ...
  def add_sensors(self, *args, **kwargs): raise NotImplementedError("add_sensor")
  def update(self, *args, **kwargs):     raise NotImplementedError("update")
